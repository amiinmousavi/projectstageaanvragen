...
using StageAanvragen.Models.Entities;

namespace StageAanvragen.Models.Data
{
    public partial class VivesStageDbContext : DbContext
    {
        ...
        public virtual DbSet<Bedrijf> Bedrijven { get; set; } = null!;
        public virtual DbSet<Contactpersoon> ContactPersonen { get; set; } = null!;
        public virtual DbSet<StageVoorstel> StageVoorstellen { get; set; } = null!;
        public virtual DbSet<StageVoorstelStatus> StageVoorstelStatussen { get; set; } = null!;
