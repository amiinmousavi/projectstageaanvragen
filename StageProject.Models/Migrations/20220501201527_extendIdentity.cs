        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stad = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    AanvragerId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    ...
                    Academiejaar = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    Semester = table.Column<int>(type: "int", nullable: false),
                    DescriptieZoekertje = table.Column<string>(type: "nvarchar(65)", maxLength: 65, nullable: false),
                    WiezijnWij = table.Column<string>(type: "nvarchar(650)", maxLength: 650, nullable: false),
                    GezochteProfiel = table.Column<string>(type: "nvarchar(650)", maxLength: 650, nullable: false),
                    Aanbieding = table.Column<string>(type: "nvarchar(650)", maxLength: 650, nullable: false),
                    StatusStagevoorstelId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "StageVoorstelStatus",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: true),
                    StatusBeschrijving = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
                });
